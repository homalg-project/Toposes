...
#! The arguments are a category $C$ and a function $F$.
#! This operation adds the given function $F$
#! to the category for the basic operation `IsomorphismFromCartesianDualToExponentialWithGivenObjects`.
#! $F: ( s, a, r ) \mapsto \mathtt{IsomorphismFromCartesianDualToExponentialWithGivenObjects}(s, a, r)$.
#! @Returns nothing
#! @Arguments C, F
DeclareOperation( "AddIsomorphismFromCartesianDualToExponentialWithGivenObjects",
                  [ IsCapCategory, IsFunction ] );
